    ...
    <div class="container-fluid py-4 px-4" style="background: #f8fafc; min-height: 100vh;">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                ...
                <p class="text-slate-500 small mb-0">Mengubah data unit usaha: <strong
                        class="text-slate-700">{{ $umkm->nama_usaha }}</strong></p>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-xl-10">
                @if ($errors->any())
                    <div class="alert alert-danger border-0 shadow-sm mb-4" style="border-radius: 15px;">
                        <div class="d-flex align-items-center text-danger">
                            ...
                            <div class="small fw-bold">Terjadi kesalahan pada input. Silakan periksa kembali formulir di
                                bawah.</div>
                        </div>
                    </div>
                @endif
                ...
                <div class="card elite-card border-0 shadow-lg overflow-hidden" style="border-radius: 25px;">
                    <div
                        class="card-header bg-slate-900 py-3 px-4 border-0 d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-white bg-opacity-10 text-sky px-3 py-1 rounded-pill small">ID
                            #{{ $umkm->umkm_id }}</span>
                    </div>

                    <div class="card-body p-4 p-md-5 bg-white">
                        <form action="{{ route('umkm.update', ['umkm' => $umkm->umkm_id]) }}" method="POST"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group-elite">
                                            ...
                                            <input type="text" name="nama_usaha"
                                                class="form-control-elite @error('nama_usaha') is-invalid-elite @enderror"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group-elite">
                                            ...
                                            <select name="pemilik_warga_id"
                                                class="form-select-elite @error('pemilik_warga_id') is-invalid-elite @enderror">
                                                @foreach ($warga as $w)
                                ...
                                <div class="row g-4">
                                    <div class="col-md-3 col-6">
                                        ...
                                        <input type="text" name="rt"
                                            class="form-control-elite px-3 @error('rt') is-invalid-elite @enderror"
                                    ...
                                    <div class="col-md-3 col-6">
                                        ...
                                        <input type="text" name="rw"
                                            class="form-control-elite px-3 @error('rw') is-invalid-elite @enderror"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group-elite">
                                            ...
                                            <input type="text" name="kategori"
                                                class="form-control-elite @error('kategori') is-invalid-elite @enderror"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group-elite">
                                            ...
                                            <input type="text" name="kontak"
                                                class="form-control-elite @error('kontak') is-invalid-elite @enderror"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group-elite">
                                            ...
                                            <input type="text" name="alamat"
                                                class="form-control-elite @error('alamat') is-invalid-elite @enderror"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-4">
                                    <div class="col-12">
                                        ...
                                        <textarea name="deskripsi" class="form-control-elite px-3 @error('deskripsi') is-invalid-elite @enderror"
                                        ...
                                        <div class="d-flex flex-wrap gap-3 mb-4">
                                            @foreach ($media as $m)
                                                <div class="media-preview-card">
                                                    <img src="{{ asset('storage/umkm_media/' . $m->file_name) }}"
                                                        alt="Media UMKM">
                                            ...
                                            <label class="upload-btn-placeholder" for="images-input">
                                                ...
                                                <input type="file" name="images[]" id="images-input" class="d-none"
                                                    multiple>
                                            </label>
                                        </div>
                                        @error('images')
                        ...
                        @foreach ($media as $m)
                            <div class="relative inline-block">
                                <img src="{{ asset('storage/produk/' . $m->file_name) }}"
                                    class="w-32 h-32 object-cover rounded">

                                <form action="{{ route('umkm.destroy_media', $m->media_id) }}" method="POST"
