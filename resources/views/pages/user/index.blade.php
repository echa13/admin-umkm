                    ...
                    <div class="card border-0 shadow-sm h-100 user-card">
                        <div class="card-body text-center p-3">
                            ...
                            <div class="position-relative d-inline-block mb-3">
                                <img src="{{ asset('asset/img/user.jpg') }}" alt="User Avatar"
                                    class="rounded-circle border border-3 border-primary shadow-sm" width="70"
...
<style>
    ...
    @media (max-width: 576px) {
        .user-card h6 { font-size: 0.95rem; }
        .user-card p { font-size: 0.75rem; }
    }
</style>
@endsection
